...
DEFAULT = {
    ...
    "possession": {
        "rank_tier1": 0.62,  # 1-4 名 持球率 (v2.2.3 0.65→0.62, 修正'强队爆冷平'偏差)
        "rank_tier2": 0.58,  # 5-8 名 (0.60→0.58)
        "rank_tier3": 0.53,  # 9-16 名 (0.55→0.53)
        "rank_tier4": 0.48,  # 17-32 名 (0.50→0.48)
        "rank_tier5": 0.43,  # 33-48 名 (0.45→0.43)
    },
    "lambda_cap": 3.2,  # λ 上限 (v2.2.3 3.5→3.2, 修 6/15 三场'强强全平' 偏差)
}
